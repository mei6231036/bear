...
<html><head>
        ...
        <title>直播个人中心</title>
        <link rel="stylesheet" href="myaccount_files/admin.css">
        <style type="text/css">
        .main-col{*padding-bottom: 140px;}
        </style>
        <script src="myaccount_files/hm.js"></script><script type="text/javascript" src="myaccount_files/jquery-1.js"></script><script type="text/javascript">
    var showCaptcha = 0;
    var indexUrl = 'http://i.huya.com/';
</script>
<script type="text/javascript" src="myaccount_files/udbUtils.js"></script>
<link rel="stylesheet" href="myaccount_files/cssfmod.css">
 <script src="myaccount_files/jsflego.js"></script>
<link href="myaccount_files/captcha.css" rel="stylesheet">
<link href="myaccount_files/account_index.css" rel="stylesheet">
<script type="text/javascript" src="myaccount_files/captcha.js"></script>
<script>
        ...
        <div class="duya-header-bd clearfix">
            ...
            <div class="duya-header-search clearfix">
                <form method="get" id="searchForm_id" name="navSearchForm" action="http://www.huya.com/search.php" target="_blank">
                    <input name="hsk" value="王者荣耀" autocomplete="off" type="text">
            ...
            <div class="duya-header-control clearfix">
                ...
                <div class="hy-nav-right nav-user success-login" style="display: block;">
                    <a class="nav-user-title" href="http://i.huya.com/" target="_blank">
                        <img id="login-userAvatar" src="myaccount_files/9c01cc867d44d2ec227888356019c2_180_135.jpg" alt="头像">
                        <span id="login-username" title="葛家小阿淼">葛家小阿淼</span>
                        <i></i>
                        ...
                        <div class="tt-user-card">
                            ...
                            <div class="u-info">
                                <a class="avatar" id="J_huyaNavUserCardAvatar" href="http://i.huya.com/" target="_blank">
                                    <img src="myaccount_files/10001.jpg" id="J_huyaNavUserCardAvatarImg">
                                </a>
                            ...
                            <div class="u-links">
                                <ul>
                                    ...
                                    <li class="links-msg" id="J_huyaNavUserMsg">
                                        <a href="mylist" target="_blank" report="{&quot;eid&quot;:&quot;click/position&quot;,&quot;position&quot;:&quot;header/usercard/entrance3&quot;}">
                                            <i></i>
                                            <p>我的消息</p>
                                        </a>
                                    ...
                                    <li class="links-play">
                                        <a href="zhubo" target="_blank" report="{&quot;eid&quot;:&quot;click/position&quot;,&quot;position&quot;:&quot;header/usercard/entrance4&quot;}">
                                            <i></i>
                                            <p>我要直播</p>
                                        </a>
                                    </li>
...
<script type="text/javascript" src="myaccount_files/account.js"></script>
<input name="greenbean_value" id="greenbean_value" value="" type="hidden">
<input name="captcha_value" id="captcha_value" value="" type="hidden">
<input name="exchangeType_value" id="exchangeType_value" value="1" type="hidden">
    


	<script src="myaccount_files/header.js"></script>
...
<script type="text/javascript" src="myaccount_files/main_menu.js"></script>
<script type="text/javascript" src="myaccount_files/cookies.js"></script>
<div class="admin-menu">
    ...
    <div class="main-col" id="propery-col">
        <div class="scroll-content">
            ...
            <div class="mod mod-propery">
                ...
                <p class="third_bind_tips">已绑定密保手机 <span id="bindMobileNum">139****5642</span></p>
                <div class="mod-bd">
                    <div class="mod mod-basic">
                    <div class="mod-hd">
                        <h4>我的财产</h4>
                        <span class="line line-protect"></span>
                                            </div>
                        <div class="mod-bd">
                            <div class="chart-content">
                                <ul class="chart chart-gift">
                                                                        <li>
                                       <span class="tool">
                                           <i class="icon icon-y"></i>
                                           <i class="txt">Y币</i>
                                       </span>
                                        <span class="tool-info">
                                            <i class="num"></i>
                                            <a href="https://pay.duowan.com/userInformationAction.action?timestamp=1507520625" target="_blank">查看</a>
                                        </span>
                                    </li>
                                                                                                            <li>
                                        <span class="tool">
                                        ...
                                        <span class="tool-info">
                                            <i class="num">0个</i>
                                                                                            <a href="http://i.huya.com/index.php?m=MyAccount&amp;do=beanDetail&amp;t=9">明细</a>
                                                                                    </span>
                                    </li>
                                                                    <li>
                                        <span class="tool">
                                        ...
                                        <span class="tool-info">
                                            <i class="num">0个</i>
                                                                                            <a href="http://i.huya.com/index.php?m=MyAccount&amp;do=beanDetail&amp;t=8">明细</a>
                                                                                    </span>
                                    </li>
                                                                    <li>
                                        <span class="tool">
                                        ...
                                        <span class="tool-info" style="margin:9px 4px;">
                                            <i class="num">0个</i>
                                                                                            <a href="http://i.huya.com/index.php?m=MyAccount&amp;do=beanDetail&amp;t=32" style="margin:0 3px 0 4px;">明细</a><a href="javascript:;" style="margin:0 3px 0 4px;" onclick="getGoldbeanExpiryDateInfo();">有效期</a>
                                                                                    </span>
                                    </li>
                                                                </ul>
                            ...
                            <div class="btn-group">
                                                                  <a target="_blank" href="https://pay.duowan.com/userInformationAction.action" class="btn btn-golden">Y币充值</a>
                                    <a href="javascript:void(0);" id="jdRechargeBtn" class="btn btn-bean">金豆充值</a>
                                    <a href="javascript:void(0);" id="ydRechargeBtn" class="btn btn-bean">银豆充值</a>
        ...
        <div class="mod mod-propery">
            ...
            <div class="mod-bd">
                <div class="mod mod-basic">
                    <div class="mod-bd">
                        <div class="chart-content">
                            <ul class="chart chart-owen">
                                                                <li>
                           <span class="tool">
                               <i class="icon icon-bao"></i>
                               <i class="txt">金元宝(分成后)</i>
                               <span><i class="num">0</i>个（0个可申请月结）</span>
                               <a href="javascript:void(0)" class="mini-q" id="detail"></a>
                           </span>
                            <span class="tool-info">   
                                <!-- 不是企业认证 -->                            
                                <a href="#" onclick="account_util.exchangeGreenbeanWindow('0','1','1');">兑换</a>                                
                                <i class="v-line">|</i>
								                                <a href="http://i.huya.com/index.php?m=MyAccount&amp;do=goldbeanUserDetail">明细</a>
                            </span>
                                </li>
                                                                                              <li>
                                 <span class="tool">
                                     ...
                                     <span>
                                         <i class="txt">上个月收入</i>
                                         <i class="num">0</i>
                                         <i class="txt">元，累计获得</i>
                                         <i class="num">0</i>
                                         <i class="txt">元</i>
                                     </span>
                                 </span>
                                  <span class="tool-info">
                                      <a href="http://pay.duowan.com/beifu/withdraw.jspx" target="_blank">提现</a>
                                      <i class="v-line">|</i>
                                      <a href="http://i.huya.com/index.php?m=MyAccount&amp;do=allCommissionDetail">明细</a>
                                  </span>
                                </li>
                                                                                        <li>
                               <span class="tool">
                               ...
                               <span class="tool-info">
                                  <a href="http://i.huya.com/index.php?m=MyAccount&amp;do=profileGiftIncome&amp;from=profileIncome">明细</a>
                               </span>
                              </li>
                                                                                      <li>
                               <span class="tool">
                               ...
                               <span class="tool-info">
                                  <a href="http://i.huya.com/index.php?m=MyAccount&amp;do=channelDetail&amp;from=channelIncome">明细</a>
                               </span>
                              </li>
                                                                                    <li>
                           <span class="tool">
                               <i class="icon icon-gold"></i>
                               <i class="txt">冻结金豆</i>
                               <span><i class="num">0</i>个（金豆竞猜权限押金）</span>
                           </span>
                            <span class="tool-info">
                           ...
                           <span class="tool">
                            ...
                            <span class="tool-info">
                                <a href="http://i.huya.com/index.php?m=MyAccount&do=channelDetail">明细</a>
                            </span>
                                </li>
                                <li>
                             <span class="tool">
                            ...
                            <span class="tool-info">
                                <a href="http://i.huya.com/index.php?m=MyAccount&do=owGuardDetail">明细</a>
                            </span>
                                </li>
                                                        -->
                                                            <li>
    ...
    <div class="mod-tips-s2" id="detail_dialog" style="display: none; position: absolute;">
    ...
    <script src="myaccount_files/moment.js"></script>
    <style>
    .j-pop{
            ...
            <div class="cont cont-verify">
                <form class="form" action="about:blank" method="post" autocomplete="on" novalidate="" accept-charset="utf-8">
                    ...
                    <div class="form-group">
                        ...
                        <img src="myaccount_files/verify_code.jpg" class="v-code">
                    </div>
...
<div class="mask">
    	...
    	<script src="myaccount_files/footer.js"></script><div class="huya-footer">
    ...
    <div class="huya-footer__bd">
        <div class="huya-footer__nav">
            ...
            <p>
                ...
                <span><img src="myaccount_files/j.gif" alt="">粤公网安备44011302000242号 </span>|
        ...
        <div class="huya-footer__hy-logo">
            <img src="myaccount_files/hy-logo.png" width="322" height="46">
            <a target="_blank" id="_pingansec_bottomimagesmall_brand" href="http://si.trustutn.org/info?sn=950170109026610628628&amp;certType=1"><img src="myaccount_files/brand_bottom_small.jpg"></a>
            <a href="https://credit.szfw.org/CX20170721035218030329.html" target="_blank"><img src="myaccount_files/sf.png"></a>
            <a href="https://credit.szfw.org/CX20170721035218020978.html" target="_blank"><img src="myaccount_files/silver.jpg"></a>
        </div>
    </div>
</div>

<script src="myaccount_files/jsfmain.js"></script>
<script type="text/javascript" src="myaccount_files/ya-huya.js" data-fixed="true" pro="huya_web" noreport="" id="yaScript"></script>
<script type="text/javascript" src="myaccount_files/report_info.js"></script>
<!--/footer-->
<!-- S 后台推送消息 -->
    <!--[if lte IE 7]>
    ...
    <script type="text/javascript" src="myaccount_files/push-min.js"></script>
    <script type="text/javascript" src="myaccount_files/push.js"></script><!-- E 后台推送消息 -->

    <script type="text/javascript" src="myaccount_files/account_index.js"></script>
</div></body></html>