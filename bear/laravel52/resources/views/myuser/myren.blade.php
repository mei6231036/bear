                	...
                	<form action="myren_do" method="POST" enctype="multipart/form-data" class="form-edit">
                		<ul>
	                		...
	                		<li>
	                			...
	                			<input class="edit-sex" type="radio" name="sex" value="0" @if($user->sex==0) checked="" @endif >男 
	                			<input class="edit-sex edit-sex_female" type="radio" value="1" name="sex" @if($user->sex==1) checked="" @endif>女
	                		</li>
	                		<li>
	                				                			<span class="edit-item">生日</span>
	                			<div class="select-box sb-year">
	                				<input id="edit-year" class="sb-selected J_sb-selected" type="text" name="sr_year" value="{{$user->sr_year}}" readonly="readonly">
	                				<ul class="sb-list">
	                			...
	                			<div class="select-box sb-month sb-number">
	                				<input id="edit-month" class="sb-selected J_sb-selected" type="text" name="sr_month" value="{{$user->sr_month}}" readonly="readonly">
	                				<ul class="sb-list">
	                			...
	                			<div class="select-box sb-date sb-number">
	                				<input id="edit-date" class="sb-selected J_sb-selected" type="text" name="sr_day" value="{{$user->sr_day}}" readonly="readonly">
	                				<ul class="sb-list">
	                		...
	                		<li>
	                			...
	                			<div class="select-box sb-prov">
	                				<input id="edit-area" class="sb-selected J_sb-selected" type="text" name="sheng" value="{{$user->sheng}}" readonly="readonly">
	                				<ul class="sb-list">
	                			...
	                			<div class="select-box sb-city">
	                				<input id="edit-location" class="sb-selected J_sb-selected" type="text" name="shi" value="{{$user->shi}}" readonly="readonly">
	                				<ul class="sb-list">
