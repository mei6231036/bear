...
<html><head>
        ...
        <title>直播个人中心</title>
        <link rel="stylesheet" href="myauth_files/admin.css">
        <style type="text/css">
        .main-col{*padding-bottom: 140px;}
        </style>
        <script src="myauth_files/hm.js"></script><script type="text/javascript" src="myauth_files/jquery-1.js"></script><script type="text/javascript" src="myauth_files/WdatePicker.js"></script><link href="myauth_files/WdatePicker.css" rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href="myauth_files/my_auth.css">

<!-- 上传头像 s-->
<script type="text/javascript" src="myauth_files/profile.js"></script>
<script src="myauth_files/jquery.js" type="text/javascript"></script>
<link rel="stylesheet" href="myauth_files/jquery.css" type="text/css">
<script type="text/javascript" src="myauth_files/jquery_002.js"></script>
<link rel="stylesheet" href="myauth_files/uploadify.css" type="text/css">
<link rel="stylesheet" href="myauth_files/yy-live.css" type="text/css">
<script type="text/javascript" src="myauth_files/ubbEditor.js"></script>
...
<body><iframe style="display: none;" src="myauth_files/storage.htm"></iframe><div class="duya-header" id="duya-header">
            ...
            <div class="duya-header-control clearfix">
                ...
                <div class="hy-nav-right nav-user success-login" style="display: block;">
                    <a class="nav-user-title" href="http://i.huya.com/" target="_blank">
                        <img id="login-userAvatar" src="myauth_files/9c01cc867d44d2ec227888356019c2_180_135.jpg" alt="头像">
                        ...
                        <div class="tt-user-card">
                            ...
                            <div class="u-info">
                                <a class="avatar" id="J_huyaNavUserCardAvatar" href="http://i.huya.com/" target="_blank">
                                    <img src="myauth_files/10001.jpg" id="J_huyaNavUserCardAvatarImg">
                                </a>
	...
	<script src="myauth_files/header.js"></script>
...
<script type="text/javascript" src="myauth_files/main_menu.js"></script>
<script type="text/javascript" src="myauth_files/cookies.js"></script>
        ...
        <div class="scroll-content">
	        <div class="mod">
				...
				<!-- 虎牙认证操作提示 add by shixubo -->
		            ...
		            <img class="qr_code" src="myauth_files/QR_code.png" alt="虎牙App">
		            <div class="h5_head">
		              <span>示意图</span>
		            </div>
		            <img src="myauth_files/sign_page_2.jpg" alt="认证方式">
	            ...
	            <p class="ques_head">常见问题解决<span><img src="myauth_files/ques_icon.png"></span></p>
	            <ul class="ques_wrap">
	            	<li>
...
$(function(){
	...
	<script src="myauth_files/footer.js"></script><div class="huya-footer">
    ...
    <div class="huya-footer__bd">
        <div class="huya-footer__nav">
            ...
            <p>
                ...
                <span><img src="myauth_files/j.gif" alt="">粤公网安备44011302000242号 </span>|
        ...
        <div class="huya-footer__hy-logo">
            <img src="myauth_files/hy-logo.png" width="322" height="46">
            <a target="_blank" id="_pingansec_bottomimagesmall_brand" href="http://si.trustutn.org/info?sn=950170109026610628628&amp;certType=1"><img src="myauth_files/brand_bottom_small.jpg"></a>
            <a href="https://credit.szfw.org/CX20170721035218030329.html" target="_blank"><img src="myauth_files/sf.png"></a>
            <a href="https://credit.szfw.org/CX20170721035218020978.html" target="_blank"><img src="myauth_files/silver.jpg"></a>
        </div>
    </div>
</div>

<script src="myauth_files/jsfmain.js"></script>
<script type="text/javascript" src="myauth_files/ya-huya.js" data-fixed="true" pro="huya_web" noreport="" id="yaScript"></script>
<script type="text/javascript" src="myauth_files/report_info.js"></script>
<!--/footer-->
<!-- S 后台推送消息 -->
    <!--[if lte IE 7]>
    ...
    <script type="text/javascript" src="myauth_files/push-min.js"></script>
    <script type="text/javascript" src="myauth_files/push.js"></script><!-- E 后台推送消息 -->
