...
<body><iframe style="display: none;" src="mylist_files/storage.htm"></iframe><div class="duya-header" id="duya-header">
            ...
            <div class="duya-header-control clearfix">
                ...
                <div class="hy-nav-right nav-user success-login" style="display: block;">
                    <a class="nav-user-title" href="http://i.huya.com/" target="_blank">
                        <img id="login-userAvatar" src="mylist_files/9c01cc867d44d2ec227888356019c2_180_135.jpg" alt="头像">
                        ...
                        <div class="tt-user-card">
                            ...
                            <div class="u-info">
                                <a class="avatar" id="J_huyaNavUserCardAvatar" href="http://i.huya.com/" target="_blank">
                                    <img src="mylist_files/10001.jpg" id="J_huyaNavUserCardAvatarImg">
                                </a>
	...
	<script src="mylist_files/header.js"></script>
...
<script type="text/javascript" src="mylist_files/main_menu.js"></script>
<script type="text/javascript" src="mylist_files/cookies.js"></script>
<div class="admin-menu">
        ...
        <div class="scroll-content">
          <div class="mod">
            ...
            <div class="mod-bd">
              ...
              <!-- 系统消息s -->
                <div class="mod-message system-message" style="overflow: hidden;" tabindex="1">
  ...
  <div class="msg">
    ...
    <div class="m-foot">
      <span class="tit">
        你的直播截图因为 图片不符合要求，请重新上传 审核不通过
        
        
      </span>
      <span class="datetime">2017-09-28</span>
    </div>
  </div>
  <!-- 消息列表end -->
    ...
    <span class="no-msg-tit">没有更多消息了！</span>
              ...
              <!-- 系统消息e -->
              <!-- 官方消息s -->
                <div class="mod-message offical-message" style="display: none; overflow: hidden;" tabindex="2">
...
<span class="no-msg-tit">当前暂无消息！</span>
  ...
  <div class="mask_bg"></div>
	<script src="mylist_files/footer.js"></script><div class="huya-footer">
    ...
    <div class="huya-footer__bd">
        <div class="huya-footer__nav">
            ...
            <p>
                ...
                <span><img src="mylist_files/j.gif" alt="">粤公网安备44011302000242号 </span>|
        ...
        <div class="huya-footer__hy-logo">
            <img src="mylist_files/hy-logo.png" width="322" height="46">
            <a target="_blank" id="_pingansec_bottomimagesmall_brand" href="http://si.trustutn.org/info?sn=950170109026610628628&amp;certType=1"><img src="mylist_files/brand_bottom_small.jpg"></a>
            <a href="https://credit.szfw.org/CX20170721035218030329.html" target="_blank"><img src="mylist_files/sf.png"></a>
            <a href="https://credit.szfw.org/CX20170721035218020978.html" target="_blank"><img src="mylist_files/silver.jpg"></a>
        </div>
    </div>
</div>

<script src="mylist_files/jsfmain.js"></script>
<script type="text/javascript" src="mylist_files/ya-huya.js" data-fixed="true" pro="huya_web" noreport="" id="yaScript"></script>
<script type="text/javascript" src="mylist_files/report_info.js"></script>
<!--/footer-->
<!-- S 后台推送消息 -->
    <!--[if lte IE 7]>
    ...
    <script type="text/javascript" src="mylist_files/push-min.js"></script>
    <script type="text/javascript" src="mylist_files/push.js"></script><!-- E 后台推送消息 -->


<script src="mylist_files/jquery.js"></script>
<script src="mylist_files/msg_list.js"></script><div id="ascrail2000" class="nicescroll-rails nicescroll-rails-vr" style="width: 5px; z-index: auto; cursor: default; position: absolute; top: 195px; left: 1318.12px; height: 1200px; display: none; opacity: 1;"><div style="position: relative; top: 0px; float: right; width: 5px; height: 0px; background-color: rgb(170, 170, 170); border: 0px none; background-clip: padding-box; border-radius: 5px;" class="nicescroll-cursors"></div></div><div id="ascrail2000-hr" class="nicescroll-rails nicescroll-rails-hr" style="height: 5px; z-index: auto; top: 1390px; left: 543.117px; position: absolute; cursor: default; display: none; opacity: 1;"><div style="position: absolute; top: 0px; height: 5px; width: 0px; background-color: rgb(170, 170, 170); border: 0px none; background-clip: padding-box; border-radius: 5px; left: 0px;" class="nicescroll-cursors"></div></div><div id="ascrail2001" class="nicescroll-rails nicescroll-rails-vr" style="width: 5px; z-index: auto; cursor: default; position: absolute; top: 0px; left: -5px; height: 1200px; display: none;"><div style="position: relative; top: 0px; float: right; width: 5px; height: 0px; background-color: rgb(170, 170, 170); border: 0px none; background-clip: padding-box; border-radius: 5px;" class="nicescroll-cursors"></div></div><div id="ascrail2001-hr" class="nicescroll-rails nicescroll-rails-hr" style="height: 5px; z-index: auto; top: 1195px; left: 0px; position: absolute; cursor: default; display: none;"><div style="position: absolute; top: 0px; height: 5px; width: 0px; background-color: rgb(170, 170, 170); border: 0px none; background-clip: padding-box; border-radius: 5px;" class="nicescroll-cursors"></div></div></body></html>