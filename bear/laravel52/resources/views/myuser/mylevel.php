            ...
            <div class="duya-header-control clearfix">
                ...
                <div class="hy-nav-right nav-user success-login" style="display: block;">
                    <a class="nav-user-title" href="http://i.huya.com/" target="_blank">
                        <img id="login-userAvatar" src="mylevel_files/9c01cc867d44d2ec227888356019c2_180_135.jpg" alt="头像">
                        ...
                        <div class="tt-user-card">
                            ...
                            <div class="u-info">
                                <a class="avatar" id="J_huyaNavUserCardAvatar" href="http://i.huya.com/" target="_blank">
                                    <img src="mylevel_files/10001.jpg" id="J_huyaNavUserCardAvatarImg">
                                </a>
...
<script type="text/javascript" src="mylevel_files/user_level_13751e2.js"></script>
	<script src="mylevel_files/footer.js"></script><div class="huya-footer">
    ...
    <div class="huya-footer__bd">
        <div class="huya-footer__nav">
            ...
            <p>
                ...
                <span><img src="mylevel_files/j.gif" alt="">粤公网安备44011302000242号 </span>|
        ...
        <div class="huya-footer__hy-logo">
            <img src="mylevel_files/hy-logo.png" width="322" height="46">
            <a target="_blank" id="_pingansec_bottomimagesmall_brand" href="http://si.trustutn.org/info?sn=950170109026610628628&amp;certType=1"><img src="mylevel_files/brand_bottom_small.jpg"></a>
            <a href="https://credit.szfw.org/CX20170721035218030329.html" target="_blank"><img src="mylevel_files/sf.png"></a>
            <a href="https://credit.szfw.org/CX20170721035218020978.html" target="_blank"><img src="mylevel_files/silver.jpg"></a>
        </div>
    </div>
</div>
